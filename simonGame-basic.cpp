...
void handlePress(XInfo &xinfo, XEvent &event, int n) {
	...
	if (sqrt(pow(event.xbutton.x-bList[0]->x,2)+pow(event.xbutton.y-bList[0]->y,2))<=50) {
		pb->x = bList[0]->x;
		pb->y = bList[0]->y;
		pbList.push_back(new PBotton(bList[0]->x,bList[0]->y,90));
		b_repaint(pbList,xinfo);
		pbList.push_back(new PBotton(bList[0]->x,bList[0]->y,80));
		b_repaint(pbList,xinfo);
		pbList.push_back(new PBotton(bList[0]->x,bList[0]->y,70));
		b_repaint(pbList,xinfo);
		pbList.push_back(new PBotton(bList[0]->x,bList[0]->y,60));
		b_repaint(pbList,xinfo);
		pbList.push_back(new PBotton(bList[0]->x,bList[0]->y,50));
		b_repaint(pbList,xinfo);
	} else if (n>1 && (sqrt(pow(event.xbutton.x-bList[1]->x,2)+pow(event.xbutton.y-bList[1]->y,2))<=50)) {
		pb->x = bList[1]->x;
		pb->y = bList[1]->y;
